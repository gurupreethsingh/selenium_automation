...
public class HomepageRegressionScenarios extends OpenClose {
    ...
    private WebDriver driver;   // just declare, don't initialize here

    @BeforeMethod(alwaysRun = true)
    public void setUpForHomepageTests() {
        // By this time, OpenClose.openApplication() has already run,
        // and DriverManager has a valid driver for this thread.
    ...
    public void clickOneEachProductOneByOne() throws InterruptedException {
        ...
        WebElement heading = driver.findElement(By.cssSelector("section.mt-16>div:first-child>h2"));
        ...
        List<WebElement> allProduct = driver.findElements(By.cssSelector("div#brandProductsCarousel>div"));
        ...
        for (int i = 1; i <= allProductCount; i++) {
            WebElement eachProduct = driver.findElement(
                    By.cssSelector("div#brandProductsCarousel>div:nth-of-type(" + i + ")"));
            ...
            AllVerifications.clickIfVisibleAndEnabled(eachProduct, driver, sa); // single-product page
            driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(20));
            ...
            WebElement expectedProductNameInSingleProductPage =
                    driver.findElement(By.cssSelector("h1.text-4xl"));
            String expectedProductNameTextSingleProductPage =
                    expectedProductNameInSingleProductPage.getText();
            AllVerifications.textIsPresentOrNot(
                    expectedProductNameTextSingleProductPage,
                    driver,
                    expectedProductNameInSingleProductPage,
                    sa
            );
