...
public class ShopAllpage extends All_Verications 
{
	// declare, (find)
	@FindBy(css = "a[href='/home']")
	private WebElement logo;
//	div.flex.items-center.gap-6>a:first-child   ( this is also for logo)
    ...
    public void verifyShopAllPageTitle(String expectedTitle, WebDriver driver, SoftAssert sa)
    {
