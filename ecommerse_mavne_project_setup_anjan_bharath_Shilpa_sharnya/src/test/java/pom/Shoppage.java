...
public class Shoppage extends AllVerifications {
	...
	// intilization
	public Shoppage(WebDriver driver) { // constrctor injection
		super(driver);
	...
	public void findAllLinksInShoppageAndPrintTextOfLinks() {
		int count = allLinks.size();
		System.out.println("Total links in shoppage found are : " + count);
