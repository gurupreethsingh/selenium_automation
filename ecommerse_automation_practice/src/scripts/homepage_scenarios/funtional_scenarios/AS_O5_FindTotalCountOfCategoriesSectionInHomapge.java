...
public class AS_O5_FindTotalCountOfCategoriesSectionInHomapge implements AutomationConstants {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		AllVerifications.verifyTotalElementsCount(driver, totalExpectedCount,
				By.cssSelector("div.flex.gap-3.overflow-x-auto>div"));
