...
public class AS_O3_FindAllParagraphs implements AutomationConstants {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		int paraCount = allpara.size();
		System.out.println("Total paragraphs found : " + paraCount);

		// print the text of paragraphs.

		for (int i = 0; i < allpara.size(); i++) {
			String eachParagraphText = allpara.get(i).getText();
			System.out.println("***************************");
			System.out.println(eachParagraphText);
			System.out.println("***************************");
			Thread.sleep(500);
		}
