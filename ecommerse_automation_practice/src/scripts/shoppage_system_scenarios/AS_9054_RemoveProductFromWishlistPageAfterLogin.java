...
public class AS_9054_RemoveProductFromWishlistPageAfterLogin implements AutomationConstants
{
	...
	public static void main(String[] args) throws InterruptedException
	{
		...
		// click on the wishlist icon of the product you want to remove from wishlist
		...
		// find the wishlist icon from header and click on it and navigate to wishlist page. 
