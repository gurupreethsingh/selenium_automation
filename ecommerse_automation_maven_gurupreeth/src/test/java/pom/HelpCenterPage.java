...
public class HelpCenterPage extends AllVerifications {
	...
	public void clickUserDropdownOption(String optionText) {
		...
		if (btn == null) {
			System.out.println("[HELPCENTERPAGE] Dropdown option not found: " + optionText);
			return;
		}
	...
	public void clickMobileMenuCartButton() {
		...
		if (cartBtn != null)
			...
			System.out.println("[HELPCENTERPAGE] Mobile Menu Cart button not found.");
	}
	...
	public void clickMobileMenuWishlistButton() {
		...
		if (wlBtn != null)
			...
			System.out.println("[HELPCENTERPAGE] Mobile Menu Wishlist button not found.");
	}
	...
	public void closeMiniCart() {
		if (!isElementPresentInDOM(miniCartPopupBy)) {
			System.out.println("[HELPCENTERPAGE] MiniCart popup is not open. Nothing to close.");
			return;
		}
	...
	public void clickMiniCartBrowseProductsWhenEmpty() {
		...
		if (!isElementPresentInDOM(miniCartBrowseProductsLinkBy)) {
			System.out.println("[HELPCENTERPAGE] Browse products link not visible (cart might not be empty).");
			return;
		}
	...
	public void removeMiniCartItemByIndex(int indexZeroBased) {
		...
		if (removeBtns.isEmpty()) {
			System.out.println("[HELPCENTERPAGE] No remove buttons found (cart empty?).");
			return;
		}

		if (indexZeroBased < 0 || indexZeroBased >= removeBtns.size()) {
			System.out.println("[HELPCENTERPAGE] Invalid remove index: " + indexZeroBased);
			return;
		}
	...
	public void clickFooterSocialLinkByIndex(int indexZeroBased) {
		if (footerSocialLinks == null || footerSocialLinks.isEmpty()) {
			System.out.println("[HELPCENTERPAGE] No footer social links found.");
			return;
		}
		if (indexZeroBased < 0 || indexZeroBased >= footerSocialLinks.size()) {
			System.out.println("[HELPCENTERPAGE] Invalid footer social index: " + indexZeroBased);
			return;
		}
	...
	public void verifyHelpCenterPageTitle(String expectedTitle) {
		verifyTitleOfWebpage(expectedTitle);
	}

	public void verifyHelpCenterPageUrl(String expectedUrl) {
