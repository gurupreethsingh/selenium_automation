...
public class CheckoutPage extends AllVerifications {
	...
	public void clickUserDropdownOption(String optionText) {
		...
		if (btn == null) {
			System.out.println("[CHECKOUTPAGE] Dropdown option not found: " + optionText);
			return;
		}
	...
	public void clickMobileMenuCartButton() {
		...
		if (cartBtn != null)
			...
			System.out.println("[CHECKOUTPAGE] Mobile Menu Cart button not found.");
	}
	...
	public void clickMobileMenuWishlistButton() {
		...
		if (wlBtn != null)
			...
			System.out.println("[CHECKOUTPAGE] Mobile Menu Wishlist button not found.");
	}
	...
	public void closeMiniCart() {
		if (!isElementPresentInDOM(miniCartPopupBy)) {
			System.out.println("[CHECKOUTPAGE] MiniCart popup is not open. Nothing to close.");
			return;
		}
	...
	public void clickMiniCartBrowseProductsWhenEmpty() {
		...
		if (!isElementPresentInDOM(miniCartBrowseProductsLinkBy)) {
			System.out.println("[CHECKOUTPAGE] Browse products link not visible (cart might not be empty).");
			return;
		}
	...
	public void removeMiniCartItemByIndex(int indexZeroBased) {
		...
		if (removeBtns.isEmpty()) {
			System.out.println("[CHECKOUTPAGE] No remove buttons found (cart empty?).");
			return;
		}

		if (indexZeroBased < 0 || indexZeroBased >= removeBtns.size()) {
			System.out.println("[CHECKOUTPAGE] Invalid remove index: " + indexZeroBased);
			return;
		}
	...
	public void clickFooterSocialLinkByIndex(int indexZeroBased) {
		if (footerSocialLinks == null || footerSocialLinks.isEmpty()) {
			System.out.println("[CHECKOUTPAGE] No footer social links found.");
			return;
		}
		if (indexZeroBased < 0 || indexZeroBased >= footerSocialLinks.size()) {
			System.out.println("[CHECKOUTPAGE] Invalid footer social index: " + indexZeroBased);
			return;
		}
