...
public class AS_SP_13_VerifyOldestProductPricefilter extends OpenClose {
...
//			System.out.println((i + 1) + " - " + eachProductName + " " + eachProductPrice);
		...
		// click on the oldeest order price button
		WebElement oldestOrderPriceButton = driver
				.findElement(By.cssSelector("div.flex.flex-wrap.gap-2 button:nth-of-type(5)"));
		Thread.sleep(500);
		oldestOrderPriceButton.click();
		Thread.sleep(2000);
