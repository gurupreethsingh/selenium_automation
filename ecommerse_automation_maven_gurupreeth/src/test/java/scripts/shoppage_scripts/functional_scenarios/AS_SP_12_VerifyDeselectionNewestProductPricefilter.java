...
public class AS_SP_12_VerifyDeselectionNewestProductPricefilter extends OpenClose {
...
//			System.out.println((i + 1) + " - " + eachProductName + " " + eachProductPrice);
		...
		WebElement newestOrderPriceButton = driver
				.findElement(By.cssSelector("div.flex.flex-wrap.gap-2 button:nth-of-type(4)"));
		Thread.sleep(500);
		newestOrderPriceButton.click();
		Thread.sleep(2000);
