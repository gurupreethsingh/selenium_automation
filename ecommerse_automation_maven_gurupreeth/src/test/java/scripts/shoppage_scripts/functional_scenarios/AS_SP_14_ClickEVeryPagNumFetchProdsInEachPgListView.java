...
public class AS_SP_14_ClickEVeryPagNumFetchProdsInEachPgListView extends OpenClose {
	...
	public void testVerifyAssendingorderPricefilter() throws InterruptedException {
		...
		WebElement listViewButton = driver
				.findElement(By.cssSelector("div.inline-flex.items-center.gap-2.w-full>div>button:nth-of-type(3)"));
