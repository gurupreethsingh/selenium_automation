...
public class AS_SP_25_CheckDescendingOrderPriceFilter extends OpenClose {
	...
	public void testAdjustPriceRangeLeftAndRightVerifyAllProductPrices() throws InterruptedException {
		...
		driver.findElement(By.cssSelector(descendingOrderButton)).click();
		Thread.sleep(100);
...
//		}
		...
		System.out.println("====================================");
		System.out.println("All products are in Descending order");
		System.out.println("====================================");
