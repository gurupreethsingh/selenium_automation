...
public class AS_SP_27_CheckOldesttOrderProductFilter extends OpenClose {
	...
	@Test
	public void testVerifyOldestOrderAndPrintProducts() throws InterruptedException {
		...
		// ✅ Click OLDEST button
		driver.findElement(By.cssSelector(oldestOrderButton)).click();
		Thread.sleep(1000);
		...
		System.out.println("====================================");
		System.out.println("Products in OLDEST Order:");
		System.out.println("====================================");
