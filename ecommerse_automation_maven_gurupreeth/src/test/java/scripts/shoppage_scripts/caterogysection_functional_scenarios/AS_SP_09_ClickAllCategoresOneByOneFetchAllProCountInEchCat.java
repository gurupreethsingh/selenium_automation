...
public class AS_SP_09_ClickAllCategoresOneByOneFetchAllProCountInEchCat extends OpenClose {
	...
	public void testFindTotalCategoryCount() throws InterruptedException {
		...
		for (WebElement eachCategory : allCategories) {
			...
			List<WebElement> allProducts = driver.findElements(By.cssSelector("main.w-full.flex-1 div.group"));
