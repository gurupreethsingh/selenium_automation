...
public class AS_SP_07_ClickAllCat1By1CountAndPrintSubCatNames extends OpenClose {
	...
	public void testFindTotalCategoryCount() throws InterruptedException {
		...
		for (WebElement eachCategory : allCategories) {
			...
			// loop to print the names of all the sub categories.
			for (int i = 0; i < subcategorycount; i++) {
				String eachSubcategoryName = allSubCategories.get(i).getText();
				System.out.println(eachSubcategoryName);
				Thread.sleep(500);
			}
