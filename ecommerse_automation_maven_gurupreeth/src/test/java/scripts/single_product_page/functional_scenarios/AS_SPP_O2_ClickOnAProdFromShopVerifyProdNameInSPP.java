...
public class AS_SPP_O2_ClickOnAProdFromShopVerifyProdNameInSPP extends OpenClose {
...
//		4. fetch then name of the product you are clicking on. and store it as expected productname.
...
//		7. title verification of spp. 
		...
		Assert.assertTrue(spp.verifyProductNameText(expectedProductName), "Product name didnot match test case failed");
		Thread.sleep(3000);
