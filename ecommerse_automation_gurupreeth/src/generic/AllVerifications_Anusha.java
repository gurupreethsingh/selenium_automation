...
public class AllVerifications_Anusha 
{
	protected WebDriver driver;
	
	protected AllVerifications_Anusha(WebDriver driver)
	{
		this.driver = driver;
	}
...
//	}
	...
	public static boolean dragSliderIfVisibleAndEnabled(
	        WebElement slider,
	        int xOffset,
	        int yOffset,
	        WebDriver driver,
	        SoftAssert sa) 
	{
	    ...
	    try {
	        ...
	        if (slider != null) {
	            ...
	            // Check if slider is displayed and enabled
	            if (slider.isDisplayed() && slider.isEnabled()) {

	                // Wait until slider is clickable
	                ...
	                dragged = true;
	                System.out.println("Slider dragged successfully: " + slider);

	            } else {
	                System.out.println("Slider is not displayed or not enabled: " + slider);
	            }

	        } else {
	            System.out.println("Slider element is null. Possibly not found in DOM.");
	        }

	    } catch (Exception ex) {
	        System.out.println("Unable to drag the slider: " + slider);
	        ex.printStackTrace();
	        TakingScreenshot.captureScreenshot(driver);
	        sa.fail("Failed to drag slider");
	    }
